...
export class CreateClientDto {
  ...
  @IsString()
  @Matches(/^\d{1,15}$/, {
    message: 'Contract number must contain 1-15 digits',
  })
  ...
  @IsString()
  @Matches(/^[0-9]{11}$/, {
    message: 'POC contact number must be exactly 11 digits',
  })
  POCContact: string;
  ...
  @IsString()
  @Matches(/^[0-9]{11}$/, {
    message: 'Alternate contact number must be exactly 11 digits',
  })
